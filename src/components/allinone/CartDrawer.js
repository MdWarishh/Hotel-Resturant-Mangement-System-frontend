// frontend/components/allinone/CartDrawer.jsx
...
// ✅ FIXED: publicApi → allinoneApi
import { formatPrice } from '@/services/allinonApi';
...
export default function CartDrawer({ isOpen, hotelCode, hotel }) {
  ...
  const handleCheckout = () => {
    closeCart();
    // ✅ FIXED: /public/ → /allinone/
    router.push(`/allinone/${hotelCode}/checkout`);
  };
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 text-black right-0 h-full w-full sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
