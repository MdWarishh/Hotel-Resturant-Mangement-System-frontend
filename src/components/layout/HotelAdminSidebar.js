...
const menu = [
  ...
  {
    name: 'Inventory',
    href: '/hotel-admin/inventory',
    icon: Boxes,
  },
  {
    name: 'POS',
    href: '/hotel-admin/pos',
    icon: Receipt,
  },
  {
    name: 'Reports',
  ...
  { name: 'Settings', icon: Settings, href: '/hotel-admin/settings' },
];
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-[rgb(57,62,70)]/10 bg-[rgb(238,238,238)]/50 p-6">
          ...
          <div>
            <h2 className="text-lg font-bold text-[rgb(34,40,49)]">Amulya Admin</h2>
            <p className="text-xs text-[rgb(57,62,70)]">Management Panel</p>
          </div>
        </div>
