...
export const getHotelByCode = async (hotelCode) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/hotels/${hotelCode}`);
    const data = await response.json();
...
export const getPublicMenu = async (hotelCode) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/menu`);
    const data = await response.json();
...
export const getPublicCategories = async (hotelCode) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/categories`);
    const data = await response.json();
...
export const getCategoryItems = async (hotelCode, categoryId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/allinone/${hotelCode}/categories/${categoryId}/items`
    );
    const data = await response.json();
...
export const getMenuItem = async (hotelCode, itemId) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/items/${itemId}`);
    const data = await response.json();
...
export const getAvailableTables = async (hotelCode) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/tables/available`);
    const data = await response.json();
...
export const getAvailableRooms = async (hotelCode) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/rooms/available`);
    const data = await response.json();
...
export const placePublicOrder = async (hotelCode, orderData) => {
  try {
    const response = await fetch(`${API_BASE_URL}/allinone/${hotelCode}/order`, {
      method: 'POST',
      headers: {
...
export const trackOrder = async (hotelCode, orderNumber) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/allinone/${hotelCode}/order/${orderNumber}`
    );
    const data = await response.json();
