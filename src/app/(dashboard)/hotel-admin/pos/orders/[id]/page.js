...
import BillPrintButton from '@/app/(dashboard)/cashier/BillPrintButton/page'
...
<script>window.onload=function(){window.print();}</script>
  ...
  {/* ✅ Full Invoice — backend PDF */}
  {isPaid && (
    <button
      onClick={handlePrintInvoice}
      className="flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold shadow-md flex-1 sm:flex-initial"
    >
