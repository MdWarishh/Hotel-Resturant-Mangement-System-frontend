          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="bg-sky-50 border border-sky-200 rounded-xl p-4 mb-6">
                <div className="flex gap-3">
                  ...
                  <div className="text-sm text-black">
                    <p className="text-black font-semibold mb-2">Template includes sample data for:</p>
                    <div className="grid grid-cols-2 gap-2 text-sky-800">
                      <div>
                        <p className="font-medium">🍽️ Restaurant:</p>
                        <ul className="list-disc list-inside text-xs ml-3 gap-3 space-y-2">
              ...
              <button
                ...
                className="text-black flex items-center gap-3 bg-blue-500 hover:bg-blue-700 hover:text-amber-50 font-semibold px-6 py-3 rounded-xl shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {downloading ? (
                  <>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <button
                    ...
                    disabled={uploading}
                    className="flex items-center gap-3 bg-sky-600 hover:bg-sky-700 text-white font-semibold px-8 py-3 rounded-xl shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {uploading ? (
                      <>
                        <Loader2 className="h-5 w-5 animate-spin" />
