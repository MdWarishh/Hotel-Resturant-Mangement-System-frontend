// app/super-admin/reports/inventory/page.js
...
export default function SuperAdminInventoryReport() {
  const { user } = useAuth()
  ...
  }, [startDate, endDate, transactionType, user])
  ...
  // Prepare data for pie chart (total cost by type)
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
              Inventory Report (System-Wide)
            </h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              Stock movements and costs across all hotels
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-12 text-center border border-gray-200 dark:border-gray-700">
            ...
            <h3 className="text-xl font-semibold mb-2">No inventory transactions</h3>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
              <SummaryCard title="Total Transactions" value={summary.totalTransactions.toLocaleString()} color="text-blue-600" />
              <SummaryCard title="Total Cost" value={`₹${summary.totalCost?.toLocaleString() || '0'}`} color="text-green-600" />
              <SummaryCard title="Items Tracked" value={new Set(report.map(r => r.item)).size.toLocaleString()} color="text-purple-600" />
            </div>
